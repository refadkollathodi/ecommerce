...
<div class="navbar">
    ...
    <nav>
        <ul>
            ...
            <li><a href="#acs"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
            ...
            if (!isset($_SESSION['id'])) {
                ?>
                <li><a href="login.php"><svg xmlns="http://www.w3.org/2000/svg" width="22" height="18" fill="currentColor"
